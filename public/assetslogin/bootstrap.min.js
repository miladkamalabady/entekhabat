...
function GetPageItems() {
    ...
    data: {
      "sliders": [
        {
          "title": null,
          "subTitle": null,
          "imageUrl": "/assets/img/login/def2.webp",
          "width": 1025,
          "height": 400,
          "href": null
        },
      ...
      "notifications": [
        {
          ...
          "title": "عمومی",
          "shortText": "1- به اطلاع داوطلبان سامانه کارا میرساند، جهت ثبت اعتراض پس از ورود به پنل کاربری خود، روی آیکن سامانه کارا کلیک و اعتراض خود را ثبت نمایید.",
          "longText": "1- به اطلاع داوطلبان سامانه کارا میرساند، جهت ثبت اعتراض پس از ورود به پنل خود، روی گزینه سامانه کارا کلیک نمایید.\r\n",
        ...
        {
          "title": "عمومی",
          "shortText": " 2- با توجه به اینکه هنوز شیوه نامه ثبت نام اتباع نهایی نشده است، امکان ثبت نام اتباع وجود ندارد. به محض دریافت شیوه نامه ثبت نام اتباع، فرآیند پیش ثبت نام آغاز خواهد شد.\r\n",
          "longText": "2- با توجه به اینکه هنوز شیوه نامه ثبت نام اتباع نهایی نشده است، امکان ثبت نام اتباع وجود ندارد. به محض دریافت شیوه نامه ثبت نام اتباع، فرآیند پیش ثبت نام آغاز خواهد شد.\r\n",
          "startDate": "2024-06-11T00:00:00",
          "endDate": "2025-03-12T00:00:00",
          "visible": true,
          "userType": null,
      ...
      "events": [
        ...
        ,
        {
          ...
          "title": "اعلام نتیجه آزمون ورودی دهم سمپاد",
          "startDate": "2024-06-26T00:00:00",
          "endDate": "2024-07-01T00:00:00",
          "pStartDate": "1403/04/06",
          "pEndtDate": "1403/06/11",
  ...
  responce.data.sliders.forEach(element => {
    if (temp == '')
      temp = '<div class="carousel-item active " style="min-height: 500px;height: 500px;"><img class="d-block" loading="lazy" src="' + element.imageUrl + '" alt="my medu" style="border-radius: 20px 0 0 20px;width:100%;max-width: 100%;margin: auto;max-height:100%;position: absolute;height: 100%;"></div>'
    else
      temp += '<div class="carousel-item " style="min-height: 500px;height: 500px;"><img class="d-block" loading="lazy" src="' + element.imageUrl + '" alt="my medu" style="border-radius: 20px 0 0 20px;width:100%;max-width: 100%;margin: auto;max-height:100%;position: absolute;height: 100%;"></div>'
  });
